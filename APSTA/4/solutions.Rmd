...
F(x)=\int f(x)
$$
It's the same, but instead of jumping at specific places it increases at a slope of $2/3$ between 0 and 1, and a slope of $1/3$ between 1 and 2.  
...
\end{aligned}
$$
THIS IS WRONG: figure out why at the exercise session.  
